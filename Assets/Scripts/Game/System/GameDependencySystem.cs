...
namespace Game.System
{
    public class GameDependencySystem : GameDependency
    {
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.Register<IStartableService, IStoppableService, IRoundService, RoundServiceImpl>(Lifetime.Singleton);
            builder.Register<IStartableService, IStoppableService, IScoringService, ScoringServiceImpl>(Lifetime.Singleton);
